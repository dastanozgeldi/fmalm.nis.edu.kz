...
export const Info = () => {
  return (
    <div>
      <div className="w-full p-4 flex flex-col md:flex-row min-h-screen justify-center bg-no-repeat bg-[url('/study.svg')] bg-contain bg-center">
        {/* Left Side */}
        <div className="mx-auto w-full max-w-md rounded-2xl p-2 space-y-4">
          <Disclosure>
            {({ open }) => (
              <>
                <Disclosure.Button
                ...
                >
                  ...
                  <Disclosure.Panel className="py-2 text-sm">
                    ...
                    национальных и международных достижений в образовании и
                    науке.
                  </Disclosure.Panel>
                </Disclosure.Button>
              </>
